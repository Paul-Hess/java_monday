...
@rem ##########################################################################
@rem
@rem  monday startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and MONDAY_OPTS to pass JVM options to this script.
...
@rem Execute monday
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MONDAY_OPTS%  -classpath "%CLASSPATH%" App %CMD_LINE_ARGS%
...
:fail
rem Set variable MONDAY_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%MONDAY_EXIT_CONSOLE%" exit 1
exit /b 1
